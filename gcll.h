...
extern const unsigned GCLL_HEAD;    ///< Flag used to insert/remove data from head (left)
extern const unsigned GCLL_TAIL;    ///< Flag used to insert/remove data from tail (right)
extern const unsigned GCLL_OK;      ///< Flag used to indicate operation success
extern const unsigned GCLL_ERROR;   ///< Flag used to indicate operation failure
